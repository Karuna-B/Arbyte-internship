...
export default function PlanCard() {
  return (
      <div className="h-[350px] w-full pointer mr-3 border rounded  ">
        ...
        <div className="border-b py-4 flex text-reg tems-center">
          ...
          <div className="ml-3">
            <h3 className="text-grey-600">Monthly Price</h3>
        ...
        <div className="border-b py-4 flex text-reg tems-center">
          ...
          <div className="ml-3">
            <h3 className="text-grey-600">South Park</h3>
        ...
        <div className="border-b py-4 flex text-reg tems-center">
          ...
          <div className="ml-3">
            <h3 className="text-grey-600">Downloads</h3>
            <h3 className="font-semibold">Included</h3>
          </div>
        </div>
      </div>
